        ...
        calculateButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                	...
                	errorMessage = "Por favor, insira um número inteiro válido.";
                    JOptionPane.showMessageDialog(FatorialView.this, errorMessage, "Erro de Entrada", JOptionPane.ERROR_MESSAGE);
